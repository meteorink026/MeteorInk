/* MeteorInk v67 service worker */
const CACHE="meteorink-v67";
const ASSETS=["./","./index.html","./styles.css","./meteorink-v67.css","./meteorink-v67.js","./meteorink-data.js","./meteorink-app.js"];
